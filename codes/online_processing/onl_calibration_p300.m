function [W] = onl_calibration_p300(low_cutoff, upper_cutoff, epoch_start,...
...
EEG = pop_loadset('filename','p300_tactile_marina.set','filepath','/arquivos/tcc/Results/olimex/17february2015');
% EEG = pop_biosig('/arquivos/tcc/Results/olimex/17february2015/p300_audio_marina.gdf', 'blockepoch','off');
